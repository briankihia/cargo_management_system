...
class Shipment(models.Model):
    ...
    cargo = models.ForeignKey('Cargo', on_delete=models.SET_NULL, null=True, related_name='shipments')
    ship = models.ForeignKey('Ship', on_delete=models.SET_NULL, null=True, related_name='shipments')
    origin_port = models.ForeignKey('Port', on_delete=models.SET_NULL, null=True, related_name='shipments_origin')
    destination_port = models.ForeignKey('Port', on_delete=models.SET_NULL, null=True, related_name='shipments_destination')
    ...
    def __str__(self):
        return f"Shipment {self.id} - {self.cargo} ({self.status})"